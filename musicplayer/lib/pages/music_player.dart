...
import 'package:musicplayer/widget/custon_appbar.dart';
...
class _TituloPlayState extends State<TituloPlay> with SingleTickerProviderStateMixin {
  ...
  void open() {
    ...
    assetAudioPlayer.open(Audio('assets/yemil.mp3'));
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          Column(
            children: <Widget>[
              Text('Maleantes Caros', style: TextStyle( fontSize: 30, color: Colors.white.withOpacity(0.8) )),
              Text('Yemil', style: TextStyle( fontSize: 15, color: Colors.white.withOpacity(0.5) )),
            ],
          ),
