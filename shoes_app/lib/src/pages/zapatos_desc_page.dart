    ...
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Hero(
            tag: 'zapato-1',
            child: ZapatosSizePreview(fullScreen:true)
            ),
          Positioned(
            top: 80,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow:[
          BoxShadow(color: Colors.black12,spreadRadius:-5,blurRadius:20,
          offset: Offset(0,10)
           )       
        ]
      ),
      ...
      child: Row(
        children: <Widget>[
         Expanded(
           child: Stack(
             children: <Widget>[
                Positioned(left:90,child: _BotonColor(Color(0xffC6D642),1,'assets/verde.png')),
                Positioned(left:60,child: _BotonColor(Color(0xffFFAD29),2,'assets/amarillo.png')),
                Positioned(left:30,child: _BotonColor(Color(0Xff2099F1),3, 'assets/azul.png')),
          ...
          Padding(
            ...
            child: BotonNaranja(texto:'More items', 
            alto:30, ancho: 100 ,color: Color(0xffFFC675),),
          )
        ],
      ),
    );
...
final String imagenUrl;
  const _BotonColor(this.color, this.index, this.imagenUrl);
  @override
  Widget build(BuildContext context) {
    return FadeInLeft(
      delay: Duration(microseconds: this.index*100),
      duration: Duration(milliseconds: 300),
          child: GestureDetector(
            onTap: (){
                final zapatoModel = Provider.of<ZapatoModel>(context, listen: false);
            zapatoModel.assetImage=this.imagenUrl;
            },
                      child: Container(
        width: 35,
        height: 35,
